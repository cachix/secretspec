...
[Read the concepts overview →](/concepts/overview/)
...
- [**Pass**](/providers/pass/) - Unix password manager with GPG encryption
- [**Proton Pass**](/providers/protonpass/) - End-to-end encrypted via Proton's official pass-cli
- [**OnePassword**](/providers/onepassword/) - Team-based password management
- [**LastPass**](/providers/lastpass/) - Cloud-based password manager
- [**Google Cloud Secret Manager**](/providers/gcsm/) - GCP managed secrets
- [**AWS Secrets Manager**](/providers/awssm/) - AWS managed secrets
- [**Vault / OpenBao**](/providers/vault/) - HashiCorp Vault and OpenBao
- [**Bitwarden Secrets Manager**](/providers/bws/) - Bitwarden Secrets Manager integration
...
*SecretSpec was designed by [Cachix](https://cachix.org) for [devenv.sh](https://devenv.sh). See the [announcement post](https://devenv.sh/blog/2025/07/21/announcing-secretspec-declarative-secrets-management/).*
