...
- **[Multiple Provider Backends](https://secretspec.dev/concepts/providers/)**:
  ...
  - [Azure App Configuration](https://secretspec.dev/providers/azappconfig) (0.19+)
...
> keyring: Uses system keychain (Recommended)
  ...
  akv: Azure Key Vault
  azappconfig: Azure App Configuration (0.19+)
...
- **[Azure App Configuration](https://secretspec.dev/providers/azappconfig)** (0.19+) - Azure key-value management with Key Vault reference resolution
