...
| [setec](/providers/setec/) (0.21+) | Tailscale Setec (requires the `setec` build feature) | ✓ | ✓ | ✓ | Depends on server key configuration |
...
- **External providers negotiate names (0.20+).** An out-of-tree endpoint asks
