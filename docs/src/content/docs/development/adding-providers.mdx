...
In SecretSpec 0.21+, construct returned text with `SecretBytes::from_utf8`.
...
In SecretSpec 0.21+, out-of-tree providers use the
...
2. `docs/astro.config.ts` — sidebar and `starlightLlmActions` provider summary
