...
unsafe extern "C" {
    pub fn DecryptDataWithFormat(
        data: *mut ::std::os::raw::c_char,
        inputFormat: *mut ::std::os::raw::c_char,
        outputFormat: *mut ::std::os::raw::c_char,
    ) -> *mut ::std::os::raw::c_char;
}
unsafe extern "C" {
    pub fn DecryptFile(
...
unsafe extern "C" {
    pub fn DecryptFileWithEnv(
        path: *mut ::std::os::raw::c_char,
        format: *mut ::std::os::raw::c_char,
        ageKeyFile: *mut ::std::os::raw::c_char,
        ageKey: *mut ::std::os::raw::c_char,
        kmsArn: *mut ::std::os::raw::c_char,
        awsProfile: *mut ::std::os::raw::c_char,
    ) -> *mut ::std::os::raw::c_char;
}
unsafe extern "C" {
    pub fn DecryptFileWithAgeKey(
        path: *mut ::std::os::raw::c_char,
        format: *mut ::std::os::raw::c_char,
        ageKeyFile: *mut ::std::os::raw::c_char,
    ) -> *mut ::std::os::raw::c_char;
