...
declaration to resolve strict inline-spec v2 JSON (SecretSpec 0.21+). The base
directory resolves relative provider paths; an older XCFramework fails to link
the versioned call.
