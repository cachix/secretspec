...
Secrets can be stored in: keyring (default), dotenv files, environment variables, 1Password, LastPass, Pass, Proton Pass, Google Cloud Secret Manager, AWS Secrets Manager, or HashiCorp Vault / OpenBao.`,
        }),
      ],
      title: "SecretSpec",
      logo: {
